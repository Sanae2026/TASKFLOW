...
function updateCounter(){
    ...
    taskCounter.textContent = "Pendientes: " + pending + " | Total: " + tasks.length;
}
...
filterStatus.addEventListener("change", function(){
    ...
    taskList.innerHTML = "";
    let filteredTasks = tasks;
    if(status === "pending") filteredTasks = tasks.filter(task => !task.completed);
    if(status === "completed") filteredTasks = tasks.filter(task => task.completed);
    filteredTasks.forEach(task => createTask(task, false));
});
